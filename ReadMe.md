...
- [check ]  A navigation bar with `About`, `Projects`, and `Contact` that link to the corresponding pages
- [check ]  Gallery of projects created with flexbox - you may use random images in place of project screenshots for now with the random image link: https://picsum.photos/ or you may use images that mean something to you
- [check ]  Information about you in place of the given placeholder
- [ check]  A `My Projects` button that links to the projects page
- [check ]  A `Contact Me` button that links to the contact page
